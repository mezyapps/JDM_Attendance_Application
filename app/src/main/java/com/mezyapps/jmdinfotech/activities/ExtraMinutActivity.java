                ...
                alertDialogBuilder.setPositiveButton("yes",
                        new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface arg0, int arg1) {
                                ...
                                Api.getClient().extraMinuts(MainActivity.userId,tv_date_picker_extra.getText().toString().trim(),tv_time_picker_from_extra.getText().toString().trim(),tv_time_picker_to_extra.getText().toString().trim(),extaminut_remarks_ed.getText().toString().trim(),
